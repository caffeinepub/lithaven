...
import type { BookType as _BookType, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBook(arg0: string, arg1: string, arg2: string, arg3: number, arg4: string, arg5: boolean, arg6: BookType): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addBook(arg0, arg1, arg2, arg3, arg4, arg5, to_candid_BookType_n8(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBook(arg0: string, arg1: string, arg2: string, arg3: string, arg4: number, arg5: string, arg6: boolean, arg7: BookType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBook(arg0, arg1, arg2, arg3, arg4, arg5, arg6, to_candid_BookType_n8(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        followedUsers: value.followedUsers,
...
function to_candid_BookType_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BookType): _BookType {
...
async function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        followedUsers: value.followedUsers,
        profilePicture: value.profilePicture ? candid_some(await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.profilePicture)) : candid_none()
    };
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BookType): {
    hardcover: null;
} | {
    ebook: null;
} | {
    ...
    return value == BookType.hardcover ? {
        hardcover: null
    } : value == BookType.ebook ? {
        ebook: null
    } : value == BookType.audiobook ? {
        audiobook: null
    } : value == BookType.softcover ? {
        softcover: null
    } : value;
}
